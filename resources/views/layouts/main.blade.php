...
<html lang="en">
	...
	<head><base href="../../../">
		...
		<link rel="shortcut icon" type="image/x-icon" href="https://www.wikipbl.org/comingSoonAssets/img/favicon.png">
					...
					<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark text-center" style="width: 100%;">
								...
								<a href="h#" target="_blank" class="text-dark-75 text-hover-primary">WikiPBL Copyright</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Nav-->
							<!--end::Nav-->
