            ...
            <div class="card card-custom">
                ...
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Reported teachers
                    </div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr v-for="user in users">
                                    ...
                                    <td>
                                        <a :href="'{{ url('/reported/users/show/')}}'+'/'+user.id" class="btn btn-info" target="_blank">Check profile</a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
            ...
            methods:{
                ...
                fetch(page = 1){
                    ...
                    if(this.query == ""){
                        ...
                        axios.get("{{ url('/reported/users/fetch') }}"+"/"+page)
                        .then(res => {
