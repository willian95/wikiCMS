            ...
            <div class="card card-custom">
                ...
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Reported institutions
                    </div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr v-for="institution in institutions">
                                    ...
                                    <td>
                                        <a :href="'{{ url('/reported/institutions/show/')}}'+'/'+institution.id" class="btn btn-info" target="_blank">Check profile</a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
            ...
            methods:{
                ...
                fetch(page = 1){
                    ...
                    if(this.query == ""){
                        ...
                        axios.get("{{ url('/reported/institutions/fetch') }}"+"/"+page)
                        .then(res => {
                ...
                search(){
                    ...
                    if(this.query == ""){
                        ...
                        axios.post("{{ url('/institutions/search') }}", {search: this.query, page: this.page}).then(res =>{
